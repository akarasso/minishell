...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/22 10:08:07 by akarasso          #+#    #+#             */
/*   Updated: 2018/09/22 10:12:05 by akarasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_dlst_del(t_dlst **container,
					void (*del_elem_func)(t_dlst_elem *));
void			ft_dlst_delif(t_dlst *container,
					int (*delif_func)(void *), void (*del)(void *));
void			ft_dlst_cut(t_dlst_elem *lst, char flag);
void			ft_dlst_delelem(t_dlst *container,
					t_dlst_elem **elem, void(*f)(void *data));
void			ft_dlst_clr(t_dlst *container, void (*f)(void *));
void			ft_dlst_iter(t_dlst *container,
					void (*exec_func)(t_dlst_elem *));
void			ft_dlst_iter_data(t_dlst *container, void (*exec_func)(void *));
void			ft_dlst_reduce(t_dlst *container,
					void (*exec_func)(t_dlst_elem *, void *), void *acc);
void			ft_dlst_reduce_data(t_dlst *container,
					void (*exec_func)(void *, void *), void *acc);
...
void			ft_dlstelem_iter_data(t_dlst_elem *elem,
					void (*exec_func)(void *elem));
